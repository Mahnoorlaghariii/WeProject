...
td, a{
  ...
  <nav class="navbar navbar-dark bg-danger margin: auto;">
    <h3 style= "color: white; margin: auto;">Student Panel</h3>
  </nav>
</div>
           <div class="container">
            <div class="innerdiv">
            ...
            <div class="leftinnerdiv">
                <br>
                <Button class="greenbtn" style="background-color: pink; color: white;" onclick="openpart('myaccount')"> <img class="icons" src="images/icon/profile.png" width="30px" height="30px"/>  My Account</Button>
<Button class="greenbtn" style="background-color: pink; color: white;" onclick="openpart('requestbook')"><img class="icons" src="images/icon/book.png" width="30px" height="30px"/> Request Book</Button>
<Button class="greenbtn" style="background-color: pink; color: white;" onclick="openpart('issuereport')"> <img class="icons" src="images/icon/monitoring.png" width="30px" height="30px"/>  Book Report</Button>
<a href="index.php"><Button class="greenbtn" style="background-color: pink; color: white;"><img class="icons" src="images/icon/logout.png" width="30px" height="30px"/> LOGOUT</Button></a>
            ...
            foreach($recordset as $row){
               ...
               "<td>$row[0]</td>";
                ...
                $table.="<td>$row[7]</td>";
                $table.="<td>$row[8]</td>";
                $table.="<td><a href='otheruser_dashboard.php?returnid=$row[0]&userlogid=$userloginid'><button type='button' class='btn btn-danger'>Return</button></a></td>";
                $table.="</tr>";
                // $table.=$row[0];
            }
            $table.="</table>";
            ...
            foreach($recordset as $row){
               ...
               $table.="<td>$row[2]</td>";
                ...
                $table.="<td>$row[6]</td>";
                $table.="<td>$row[7]</td>";
                $table.="<td><a href='requestbook.php?bookid=$row[0]&userid=$userloginid'><button type='button' class='btn btn-danger'>Request Book</button></a></td>";
