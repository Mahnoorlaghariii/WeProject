...
elseif($msg=="fail"){
  ...
  <nav class="navbar navbar-dark bg-danger margin: auto;">
    <h3 style= "color: white; margin: auto;">Admin Panel</h3>
  </nav>
</div>
            ...
            <div style= "margin-top:80px" class="rightinnerdiv">   
            ...
            margin-top: 20px;
            cursor: pointer;
            border-radius: 5px;">ADD NEW BOOK</Button>
            <br>
            ...
            margin-top: 20px;
            cursor: pointer;
            border-radius: 5px;">ADD PERSON</Button>
           <form action="addpersonserver_page.php" method="post" enctype="multipart/form-data" style="color: black;">
    <label style="font-weight: bold;">Name:</label><br>
    <input type="text" name="addname" style="border: 1px solid #4CAF50; border-radius: 5px; padding: 5px;"><br>
    <label style="font-weight: bold;">Password:</label><br>
    <input type="password" name="addpass" style="border: 1px solid #4CAF50; border-radius: 5px; padding: 5px;"><br>
    <label style="font-weight: bold;">Email:</label><br>
    <input type="email" name="addemail" style="border: 1px solid #4CAF50; border-radius: 5px; padding: 5px;"><br>
    <label style="font-weight: bold;" for="type">Choose type:</label><br>
    <select name="type" style="border: 1px solid #4CAF50; border-radius: 5px; padding: 5px; background-color: #fff;">
        <option value="student">student</option>
        <option value="teacher">teacher</option>
    </select><br>
    <input type="submit" value="SUBMIT" style="background-color: #4CAF50; color: white; border: none; border-radius: 5px; padding: 10px 20px; cursor: pointer;">
</form>
